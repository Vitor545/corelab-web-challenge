    ...
    <section>
      ...
      <div className="container section_home">
        <div className="section__home">
          <h3 data-testid="home_title_my_1">Meus</h3>
          <h1 data-testid="home_title_my_2">Anúncios</h1>
        </div>
        <SwiperCard isMy />
      </div>
      <div className="container section_home">
        <div className="section__home">
          <h3 data-testid="home_title_all_1">Todos os</h3>
          <h1 data-testid="home_title_all_2">Anúncios</h1>
        </div>
